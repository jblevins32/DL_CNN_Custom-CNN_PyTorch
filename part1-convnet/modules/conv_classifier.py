...
class ConvNet:
    ...
    def forward(self, x, y):
        ...
        # Assign the input for ease of loop usage
        out = x
        
        # Iterate through the modules, feeding out into the next module
        for module in self.modules:
            out = module.forward(out)
        
        # Final calculation of probs and loss    
    ...
    def backward(self):
        ...
        # Backward pass from the criterion
        self.criterion.backward()
        dout = self.criterion.dx
        
        # Backward pass through each module in reverse order
